  ...
  describe('navigation()', () => {
    ...
    it('excludes navigation() from a runtime App Shell', async () => {
      ...
      await act(async () => {
        ...
        { includes: 'App shell for navigation', kind: 'runtime' }, // FIXME: will go away in https://github.com/vercel/next.js/pull/97524
      ])
  ...
  describe('prefetch()', () => {
    ...
    it('excludes prefetch() from a runtime App Shell', async () => {
      ...
      await act(async () => {
        ...
        { includes: 'App shell for prefetch', kind: 'runtime' }, // FIXME: will go away in https://github.com/vercel/next.js/pull/97524
      ])
